...
export default async function handler(req, res) {
  ...
  // GET → Status-Check: welche Provider sind serverseitig konfiguriert?
  // Wird vom Frontend beim Laden aufgerufen, um das Provider-Dropdown
  // dynamisch zu befüllen (nicht-konfigurierte Optionen werden deaktiviert).
  if (req.method === 'GET') {
